...
- (void)initUI
{
    ...
    self.bgImageView.image = [[UIImage imageNamed:@"poi_content"] resizableImageWithCapInsets:UIEdgeInsetsMake(7, 7, 7, 7)];
    ...
    [self.contentView addSubview:self.locIconView];
